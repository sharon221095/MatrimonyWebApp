...
const About = () => {
  ...
  return (
    <div className='body'>
        ...
        <nav className={navVisible ? 'visible' : 'hidden'}>
            ...
            <div className="profile-picture-container2" onClick={toggleDropdown} ref={dropdownRef}>
                    <img
                    ...
                    />
                {dropdownOpen && (
                    <div className="dropdown-menu2 show" aria-labelledby="dropdownMenuButton">
                        <button className="dropdown-item2" onClick={()=>handleEditProfile(profilePictureUrl)}>Edit Profile</button>
                        <button className="dropdown-item2" onClick={handleLogout}>Logout</button>
                    </div>
                )}
            </div>

            {/* Toggle Button for Mobile */}
         <button className="nav-toggle2" onClick={toggleNav} aria-label="Toggle Navigation">
          ☰
        </button>
    ...
    <div className="parent-container770">
  <div className="check14">
  ...
  <div className="container770">
    ...
    <div className="parent-container880">
    <div className="container880 text-center">
