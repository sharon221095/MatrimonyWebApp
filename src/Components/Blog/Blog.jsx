  ...
  return (
    <div className='body'>
        ...
        <nav className={navVisible ? 'visible' : 'hidden'}>
            ...
            <div className="profile-picture-container6" onClick={toggleDropdown} ref={dropdownRef}>
                    <img
                        src={profilePictureUrl ? profilePictureUrl : image63 } 
                        alt="Profile"
                        className="profile-picture6"
                    />
                {dropdownOpen && (
                    <div className="dropdown-menu6 show" aria-labelledby="dropdownMenuButton">
                        <button className="dropdown-item6" onClick={()=>handleEditProfile(profilePictureUrl)}>Edit Profile</button>
                        <button className="dropdown-item6" onClick={handleLogout}>Logout</button>
                    </div>
                )}
            </div>
         ...
         <button className="nav-toggle6" onClick={toggleNav} aria-label="Toggle Navigation">
          ☰
        </button>
